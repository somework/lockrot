...
{
    public static function createAnalyzer(IOInterface $io, Config $config, LockrotConfig $lockrot, ?string $githubToken, Clock $clock): Analyzer
    {
    ...
    public static function createHttp(IOInterface $io, Config $config, LockrotConfig $lockrot, Clock $clock): CachingHttpClient
    {
        ...
        return new CachingHttpClient(new ComposerHttpClient($downloader, $clock), self::createCache($io, $config), $lockrot->cacheTtl(), $clock, $lockrot->offline(), $lockrot->refresh());
    }
