...
- `src/Composer/InstallTimeSummary.php:144` UnwrapArrayValues — `RepositoryManager::getRepositories()`
...
- `src/Composer/LockrotCommand.php:201` Throw_ — not rethrowing `$this->bootstrapError` changes
